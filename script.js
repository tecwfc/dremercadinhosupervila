...
function entrarNoApp() {
  ...
  // Carregar dados
  setTimeout(() => {
    carregarDescricoesSelect();      // Carrega descrições para o select
    carregarListaDescricoes();       // <-- ADICIONAR ESTA LINHA: Carrega lista para config
